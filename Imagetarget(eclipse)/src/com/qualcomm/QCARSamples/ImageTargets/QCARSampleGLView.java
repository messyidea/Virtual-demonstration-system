...
public class QCARSampleGLView extends GLSurfaceView
{
    ...
    public native void bigger();
    public native void small();
    public native void Rotatex(float bx);
    public native void Rotatey(float by);
	@Override
	public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_POINTER_UP:  //唯一的点被放开
            isZoom = false;  
            onekeydown = false;
            break;  
        ...
        case MotionEvent.ACTION_POINTER_DOWN:  
            ...
            frame=new int[]{this.getLeft(),this.getTop(), this.getRight(), this.getBottom()};
            isZoom = true;  
            onekeydown = false;
            break;  
        ...
        case MotionEvent.ACTION_MOVE:  
        	if(onekeydown){
                ...
                Rotatex((newx - oldx)/260);
                Rotatey(-(newy - oldy)/160);
        		;
        	}
            if (isZoom) {  
            	float newDist = spacing(event);                                                                  
                int absDist=(int)(newDist-oldDist);	
                if(absDist > 0){
